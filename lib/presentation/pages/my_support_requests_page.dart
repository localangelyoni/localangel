        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                TextField(
                  decoration: const InputDecoration(prefixIcon: Icon(Icons.search), hintText: 'חפש בקשות...'),
                  ...
                  children: [
                    for (final t in ['all', 'open', 'completed'])
                      Padding(
                        ...
                        child: ChoiceChip(
                          label: Text(t == 'all' ? 'הכל' : t == 'open' ? 'פתוח' : 'הושלם'),
                          selected: _filter == t,
                ...
                : filtered.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          child: Text(status == 'open' ? 'פתוח' : status == 'completed' ? 'הושלם' : status == 'in_progress' ? 'בתהליך' : status),
                              ),
                            ),
                          );
                        },
